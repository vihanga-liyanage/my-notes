...
echo "=========================================================="
sudo apt-get install -y numix-icon-theme numix-icon-theme-circle numix-gtk-theme
...
echo "=========================================================="
echo "Installing open in terminal context menu item..."
echo "=========================================================="
sudo apt-get install -y nautilus-open-terminal
nautilus -q

echo "=========================================================="
echo "Installing touch pad drivers..."
echo "=========================================================="
sudo apt-get install -y kde-config-touchpad
echo "=========================================================="
echo "Please setup touch pad prefferences to continue..."
echo "=========================================================="
synaptiks